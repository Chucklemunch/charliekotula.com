...
function About() {
  const images = [
  { src: "/char_golf.jpg", description: "bachelor party" },
  { src: "/char_jonathan_bjj.jpg", description: "jiu-jitsu" },
  { src: "/char_river.jpg", description: "post-concussion cold water therapy (not a legitmate medical protocol)" },
  { src: "/char_stringray.jpg", description: "stingray" },
  { src: "/contemplating_life.jpg", description: "contemplating my existence" },
]
